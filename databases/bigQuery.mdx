...
<img
  src="/images/183_2x_shots_so.png"
  alt="Adding connection to index"
  title="Adding connection to index"
  className="mx-auto"
/>

2. **Add Connection**: Click **Add Connection**.
3. **Select Connection Type**: Select **BigQuery** from the dropdown.

![BigQuery Connection on Index](/images/178_2x_shots_so.png)

4. **Region**: You've set this up yourself in the Region selector on BigQuery.
   - If you whitelist IPs, add **35.193.242.153**.
5. **Service account**: Paste your JSON service account.

   _Sample JSON Configuration_
...
6. **Name**: Enter a connection name (e.g., “CompanyName Connection”).
7. **Test**: Click Test connection, then **Add connection**.
