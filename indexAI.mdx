...
Your charts draw directly from your metric catalog definitions, ensuring accuracy. While Index AI strives to provide relevant visualizations, as a beta feature, it may occasionally misinterpret queries. We recommend validating insights before making critical decisions[1].
...
Index AI's chart builder runs on GPT-4o from OpenAI[1].
...
To remove Index AI from your workspace or opt out of the beta, simply reach out to our support team[1].

Citations:
[1] https://help.steep.app/using-steep/ai
[2] https://help.steep.app/using-steep/ai